...
// Replaced from 'stock' view to only get sticky widgets
$widgets = get_user_widgets_from_sticky(page_owner(), $type, $context);
$area1widgets = $widgets[0];
$area2widgets = $widgets[1];
$area3widgets = $widgets[2];

//$area1widgets = get_user_widgets_from_sticky($user->guid,$type, $type, ', 1);
//$area2widgets = get_user_widgets_from_sticky(2,$type,$where, 'sticky_widgets',2);
//$area3widgets = get_user_widgets_from_sticky(2,$type,$where,  'sticky_widgets',3);
